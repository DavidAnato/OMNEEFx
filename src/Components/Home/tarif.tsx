        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full sm:w-1/3 px-1">
            <div className="bg-white p-5 rounded-l-lg h-full flex flex-col">
              ...
              <h3 className="text-2xl font-extrabold text-center mb-3 bg-red-200 p-3 rounded-lg text-primary" style={{ backgroundColor: 'rgba(255, 0, 0, 0.05)' }}>OMNEE PLATINUM</h3>
            ...
            <div className="bg-primary text-white p-5 rounded-lg h-full flex flex-col transform scale-105">
              ...
              <ul className="mb-3">
                <li className="mb-1 flex items-start">
                  ...
                  <span><strong className="text-white">Publique cible:</strong> Traders intermédiaires cherchant à approfondir leurs connaissances.</span>
                </li>
                <li className="mb-1 flex items-start">
                  <img src={bulletPoint} alt="Bullet point" className="mr-2 w-6 h-6 mt-1"  style={{ filter: 'brightness(0) invert(1)' }}/>
                  <span><strong className="text-white">Objectif:</strong> Améliorer les compétences de trading et préparer les participants à une certification.</span>
                </li>
              </ul>
              <h3 className="text-2xl font-extrabold text-center mb-3 bg-blue-800 p-3 rounded-lg text-white" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)' }}>OMNEE GOLD</h3>
              <ul className="mb-3 p-3 rounded-lg flex-grow" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
                ...
                <span><strong className="text-white">Analyse Technique Avancée:</strong> Figures chartistes, indicateurs avancés, analyse multi-timeframe, théories avancées.</span>
                </li>
                <li className="mb-1 flex items-start">
                <img src={bulletPoint} alt="Bullet point" className="mr-2 w-4 h-4 mt-1" style={{ filter: 'brightness(0) invert(1)' }} />
                <span><strong className="text-white">Stratégies de Trading Sophistiquées:</strong> Day trading, swing trading, arbitrage, scalping.</span>
                </li>
                <li className="mb-1 flex items-start">
                  <img src={bulletPoint} alt="Bullet point" className="mr-2 w-4 h-4 mt-1" style={{ filter: 'brightness(0) invert(1)' }} />
                  <span><strong className="text-white">Gestion de Portefeuille:</strong> Diversification, couverture, évaluation et ajustement de portefeuille.</span>
                </li>
                <div className="text-center mt-3">
            ...
            <div className="bg-white p-5 rounded-r-lg h-full flex flex-col">
              ...
              <ul className="mb-3">
                <li className="mb-1 flex items-start">
                  ...
                  <span><strong className="text-primary">Publique cible:</strong> Débutants en trading.</span>
                </li>
                <li className="mb-1 flex items-start">
                  <img src={bulletPoint} alt="Bullet point" className="mr-2 w-6 h-6 mt-1" />
                  <span><strong className="text-primary">Objectif:</strong> Fournir une base solide pour commencer à trader de manière autonome.</span>
                </li>
              </ul>
              <h3 className="text-2xl font-extrabold text-center mb-3 bg-red-200 p-3 rounded-lg text-primary" style={{ backgroundColor: 'rgba(255, 0, 0, 0.05)' }}>OMNEE SILVER</h3>
              <ul className="mb-3 bg-gray-50 p-3 rounded-lg flex-grow">
                <li className="mb-1 flex items-start">
                  <img src={bulletPoint} alt="Bullet point" className="mr-2 w-4 h-4 mt-1" />
                  <span><strong className="text-primary">Introduction au Trading:</strong> Concepts de base des marchés financiers.</span>
                </li>
                <li className="mb-1 flex items-start">
                  <img src={bulletPoint} alt="Bullet point" className="mr-2 w-4 h-4 mt-1" />
                  <span><strong className="text-primary">Analyse Technique de Base:</strong> Types de graphiques, support et résistance, indicateurs de base.</span>
                </li>
                <li className="mb-1 flex items-start">
                  <img src={bulletPoint} alt="Bullet point" className="mr-2 w-4 h-4 mt-1" />
                  <span><strong className="text-primary">Analyse Fondamentale de Base:</strong> Introduction à l'analyse des nouvelles économiques et des états financiers.</span>
                </li>
                <div className="text-center mt-3">
                  <button className="btn btn-sm btn-outline btn-primary rounded-lg px-12">Lire plus</button>
                </div>
