    ...
    <div className='w-full p-5'>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center relative">
            <div className="md:w-1/2 text-center md:text-left z-10 p-5 xl:p-10">
                <span className="text-sm p-1 px-3 bg-secondary font-bold">Bienvenue chez OMNEEFx</span>
                <h1 className="text-[60px] leading-none font-bold mb-4 mt-8">Commencez <br /> votre excellence <br /> en trading !</h1>
                <p className="text-sm mb-6">Bienvenue chez OMNEEFx, l'académie où commence votre <br /> parcours vers l’excellence en trading.</p>
